	...
	market(_market)
{
	...
	std::vector<TradeItemBuy> goods = market->availableItemsIds(EMarketMode::GOLD_SECSKILL_BASIC);
...
{
	LOCPLINT->cb->trade(market, EMarketMode::GOLD_SECSKILL_BASIC, GameResID(GameResID::GOLD), skill, 1, hero);
}
